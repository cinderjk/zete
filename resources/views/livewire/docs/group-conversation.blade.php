<div>
    <table class="table table-bordered table-striped">
        <tbody>
            ...
            <tr>
                <td>URL</td>
                <td>{{ config('app.url') }}/api/v1/groups/conversation</td>
            </tr>
            <tr>
                <td>Format Data</td>
                <td>JSON</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <pre class="mb-0">  "group_id": "xx",</pre>
            ...
            <tr>
                <td>Example PHP</td>
                <td>
                    <pre class="mb-0">$url = '{{ config('app.url') }}/api/groups/conversation';</pre>
                    <pre class="mb-0">$data = '{"device_id": "xx", "group_id" : "xx", "limit" : 25}';</pre>
