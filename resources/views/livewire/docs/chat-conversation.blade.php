<div>
    <table class="table table-bordered table-striped">
        <tbody>
            ...
            <tr>
                <td>URL</td>
                <td>{{ config('app.url') }}/api/v1/chats/conversation</td>
            </tr>
            <tr>
                <td>Format Data</td>
                <td>JSON</td>
            ...
            <tr>
                <td>Example PHP</td>
                <td>
                    <pre class="mb-0">$url = '{{ config('app.url') }}/api/chats/conversation';</pre>
                    <pre class="mb-0">$data = '{"device_id": "xx", "phone" : "62822xxxxxxx", "limit" : 25}';</pre>
